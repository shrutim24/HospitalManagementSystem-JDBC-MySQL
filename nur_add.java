...
public class nur_add extends javax.swing.JFrame {

    /**
     * Creates new form nur_add
     */
    public nur_add() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        dispose();
        admin_nur fms2s= new admin_nur();
        fms2s.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            myRs=myStmt.executeQuery("Select max(nid) from nurse");
            if(myRs.next()){
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(did1.length()==0||rid.length()==0|| fname.length()==0 || lname.length()==0 || age.length()==0 || gen.length()==0 || ad.length()==0 || shift.length()==0 || sal.length()==0 || pass.length()==0 || cont.length()==0)
        {
            ...
            try{
                ...
                {
                    try{
                        String insert="INSERT INTO nurse VALUES('"+rid+"','"+fname+"','"+lname+"','"+age+"','"+gen+"','"+shift+"','"+sal+"','"+pass+"','"+cont+"','"+did1+"','"+ad+"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nur_add.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
