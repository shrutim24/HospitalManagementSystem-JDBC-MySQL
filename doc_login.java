...
public class doc_login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            myRs=myStmt.executeQuery("Select * from doctor where ddid='"+name+"'");
            if(myRs.next()){
                myRs=myStmt.executeQuery("Select * from doctor where ddid='"+name+"' and dpass='"+pass+"' ");
                if(myRs.next()){

                    tx[0]=myRs.getString(2);
                    JOptionPane.showMessageDialog(null,"Successfull");
                    dispose();
                    doctorh fsgms=new doctorh();
